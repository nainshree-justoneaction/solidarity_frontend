...
export default function PaymentClient() {
  ...
  const email = "student@email.com"; // later from auth
      ...
      <main className="w-full max-w-3xl mx-auto px-6 py-20">
        ...
        <div className="rounded-3xl border border-green-400/30 bg-green-500/5 p-10 text-center">
          ...
          <button
            ...
            className="
              px-14 py-5 text-xl font-semibold rounded-2xl
        ...
        <p className="text-white/40 text-sm mt-10 text-center max-w-xl mx-auto">
          This is not a fee. Your contribution directly supports
          social impact initiatives and enables certification.
        </p>
      </main>
    </div>
  );
