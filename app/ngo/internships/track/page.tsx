    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <button onClick={() => router.push("/ngo/internships/post")} className="bg-white text-black px-3 py-2 rounded-md">Post Internship</button>
          <button onClick={() => router.push("/ngo/internships/applicants")} className="px-3 py-2 text-zinc-300 border border-zinc-800 rounded-md">All Applicants</button>
        </div>
      </div>
